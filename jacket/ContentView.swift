...
struct ContentView: View {
        ...
        VStack{
            ...
            VStack {
                ...
                if isConnected {
                    ...
                    Button("send"){
                        env.stringVal = report1()
                        env.stringValMotors = report2()
                        env.stringFinal = env.stringValMotors + env.stringVal
                        sendString(env.stringFinal)
    ...
    func sendString(_ val: String) {
        bluetooth.send(Array(val.utf8))
    }
    func report1() -> String {
...
class GlobalEnvironment1: ObservableObject {
    ...
    @Published var stringFinal: String = ""
